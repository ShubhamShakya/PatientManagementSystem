...
public class AlternatePatientRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.alternate_patient_register);
                ...
                registerPatientButton = (Button) findViewById(R.id.buttonPatientRegister);
        ...
        mAuth.createUserWithEmailAndPassword(emailString,passwordString).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    Toast.makeText(AlternatePatientRegister.this,"Patient Registered Successfully",Toast.LENGTH_SHORT).show();
                    ...
                    root.push().setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(AlternatePatientRegister.this,"Successfully added",Toast.LENGTH_SHORT).show();
                            }else{
                                Toast.makeText(AlternatePatientRegister.this,"Data adding failed"+task.getException().getMessage(),Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    //todo open login activity
                    startActivity(new Intent(AlternatePatientRegister.this,PatientLogin.class));
                }else{
                    progressBar.setVisibility(View.INVISIBLE);
                    registerPatientButton.setVisibility(View.VISIBLE);
                    Toast.makeText(AlternatePatientRegister.this,"Registration Error!"+task.getException().getMessage(),Toast.LENGTH_SHORT).show();
                }
            }
        });
        this.finish();
